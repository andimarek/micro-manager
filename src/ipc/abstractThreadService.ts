...
export abstract class AbstractThreadService implements IManyHandler {
	...
	protected abstract _callOnRemote(proxyId: string, path: string, args: any[]): Promise<any>;
}


export class ThreadService extends AbstractThreadService implements IThreadService {
	...
	protected _callOnRemote(proxyId: string, path: string, args: any[]): Promise<any> {
